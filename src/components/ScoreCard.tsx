...
export const ScoreCard = ({ name, score, is_skeleton }: IScoreCard) => {
  return (
    <div className="w-1/4 flex flex-col rounded-lg bg-purple-100 border border-purple-700 text-purple-950 p-4 shadow-md">
      {!is_skeleton ? (
      ...
      {!is_skeleton ? (
        <p className="mt-3 text-center text-lg text-purple-700">{score} point(s)</p>
      ) : (
        <div className="flex justify-center">
